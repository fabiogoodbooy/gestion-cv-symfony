 ...
 */
final class Version20181227153327 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D6492195E0F0 ON user (specialite_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D6492195E0F0 ON user');
