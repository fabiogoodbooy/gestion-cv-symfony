...
// Returns the private 'App\Repository\CvRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CvRepository.php';

return $this->privates['App\Repository\CvRepository'] = new \App\Repository\CvRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
