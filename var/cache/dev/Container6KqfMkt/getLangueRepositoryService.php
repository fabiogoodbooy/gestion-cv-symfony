...
// Returns the private 'App\Repository\LangueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LangueRepository.php';

return $this->privates['App\Repository\LangueRepository'] = new \App\Repository\LangueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
