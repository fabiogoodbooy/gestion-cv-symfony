...
// Returns the private 'App\Repository\ExperienceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ExperienceRepository.php';

return $this->privates['App\Repository\ExperienceRepository'] = new \App\Repository\ExperienceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
